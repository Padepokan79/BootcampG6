...
public class Test {
	public static void main (String[]args) {
		...
		if (pekerjaan.equalsIgnoreCase("Programmer")) {
			...
			PG k = new PG(nama, nik, penempatanKerja, pekerjaan, kategoripegawai, lamakerja, status, jmlfixingbug);
			System.out.println("Gaji Pokok           : " + (int) k.getgaji());
			System.out.println("Gaji Lembur          : " + (int) k.getgajilembur());
			...
			System.out.println("Tunjangan Keluarga   : " + (int) k.getstatus());
			...
			System.out.println("Gaji Lembur          : " + (int) s.getgajilembur());
			...
			System.out.println("Tunjangan Keluarga   : " + (int) s.getstatus());
