...
public abstract class Karyawan implements UMK, TunjanganPegawai{
	private String namaK,  noNIK, penempatanKerja, pekerjaan, kategoripegawai, status;
	private double umk;
	private int lamakerja, tunjangan=0, lamalembur, tunjangTransport;
	boolean isTrue;

	protected Karyawan (String namaK, String noNIK, String penempatanKerja, String pekerjaan, String kategoripegawai, int lamakerja, String status, int lamalembur){
		this.namaK = namaK;
		this.noNIK = noNIK;
