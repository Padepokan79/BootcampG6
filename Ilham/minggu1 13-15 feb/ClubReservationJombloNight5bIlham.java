...
public class ClubReservationJombloNight5bIlham {
	public static void main(String[] args) {
		...
		System.out.println("Club Reservation : Jomblo Night 5b");
		System.out.println("--------------------------------------------------------");
		...
		//proses hasil
		hasil = (hari.equalsIgnoreCase("sabtu") && (jenisKelamin.equalsIgnoreCase("cewek") || jenisKelamin.equalsIgnoreCase("cowok")) && penampilan >= 8 && umur >= 21 && umur <= 30);
