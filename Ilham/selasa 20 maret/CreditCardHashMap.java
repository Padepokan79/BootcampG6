...
public class CreditCardHashMap {
	...
	public CreditCardHashMap(String pemilik, String jenisCreditCard) {
	...
	public CreditCardHashMap(String pemilik, String jenisCreditCardSatu, String jenisCreditCardDua) {
		this.pemilik = pemilik;
