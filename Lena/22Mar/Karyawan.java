...
public class Karyawan extends AbstrakKaryawan implements InterfaceUMK, InterfaceTunjangan, InterfacePTKP, InterfacePPH{
	...
	public void setTunjanganPegawai(double tunjanganPegawai) {
		this.tunjanganPegawai = tunjanganPegawai;
	}
	public double getTunjanganMenikah() {
		return tunjanganMenikah;
	}
	public void setTunjanganMenikah(double tunjanganMenikah) {
		this.tunjanganMenikah = tunjanganMenikah;
	}
	...
	@Override
	public void mencariTunjanganTransport() {
		// TODO Auto-generated method stub
		double tunjangan = 0;
		if(penempatanKerja.equalsIgnoreCase("jakarta")) {
			tunjangan = tunjanganTransportJakarta; 
		}
		setTunjanganTransportasi(tunjangan);
	}
