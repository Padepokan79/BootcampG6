...
public abstract class PegawaiPNS implements GajiPokok, Tunjangan, Potongan{
	...
	//men-set masa kerja berdasarkan golongan menjadi maksimal
	private void setMasaKerjaMax() {
		if(golongan.substring(0, 1).equals("1")) {
			if(masaKerja > MASA_KERJA_MAX_GOL1) {
				masaKerja = MASA_KERJA_MAX_GOL1;
			}
		}
		else if(golongan.substring(0, 1).equals("2")) {
			if(masaKerja > MASA_KERJA_MAX_GOL2) {
				masaKerja = MASA_KERJA_MAX_GOL2;
			}
		}
		else if(golongan.substring(0, 1).equals("3")) {
			if(masaKerja > MASA_KERJA_MAX_GOL3) {
				masaKerja = MASA_KERJA_MAX_GOL3;
			}
		}
		else if(golongan.substring(0, 1).equals("4")){
			if(masaKerja > MASA_KERJA_MAX_GOL4) {
				masaKerja = MASA_KERJA_MAX_GOL4;
			}
		}
	}
	
	//insert data gaji pokok ke hashmap
	//===================================================hashMap=======================================================
	...
	//menghitung gaji kotor sebelum PPH
	...
	//menghitung penghasilan kotor setelah ditambahkan PPH
	...
	//mencari biaya potongan taperum
